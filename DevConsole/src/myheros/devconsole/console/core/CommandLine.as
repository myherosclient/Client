...
* 
*/
package myheros.devconsole.console.core 
{
	import flash.utils.ByteArray;
	import flash.utils.getQualifiedClassName;
	import myheros.devconsole.console.Console;
	import myheros.devconsole.console.vos.WeakObject;
	import myheros.devconsole.console.vos.WeakRef;
			...
			if(_slashCmds[cmd] != null){
				try{
					...
					if(param.length == 0){
						...
						slashcmd.f.apply(null, param.replace( /^\s+|\s+$/g, "" ).split(" "));
					}
					if(restStr){
						run(restStr);
					}
